/* The code snippet provided is a JavaScript function that retrieves and categorizes failed login
attempts. Here's a breakdown of what it does: */
...
exports.getFailedAttemptsData = async () => {
    ...
    const clientes = failedAttempts.filter(user => user.tipo_usuario === 'cliente');
    const administradores = failedAttempts.filter(user => user.tipo_usuario === 'administrador');
